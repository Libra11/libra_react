...
export const BlogItemMobile: React.FC<IBlogItem> = ({ blog }) => {
  ...
  return (
    <div
      onClick={goDetail}
      className="image_scale animate__animated animate__headShake w-full rounded-lg overflow-hidden cursor-pointer border border-[var(--card-border)] transition-all flex items-start justify-start mx-2 mt-3"
    >
      <img
        className=" h-[160px] w-[50%] object-cover"
        src={`${blog.imgUrl}`}
        alt=""
      />
